...
<body>
  <nav class="navbar navbar-expand-sm navbar-dark bg-info">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navlists">
     <ul class="navbar-nav ">
      <li class="nav-item"><a class="nav-link" href="#">aaa</a></li>
      <li class="nav-item"><a class="nav-link" href="#">bbb</a></li>
      <li class="nav-item"><a class="nav-link" href="#">ccc</a></li>
      <li class="nav-item"><a class="nav-link" href="#">ddd</a></li>
    </ul>
    </div>
    </div>
  </nav>
              ...
              <form action="" method="post" autocomplete="off">
               ...
               <!-- Username input -->
                <div class="input-group mb-3">
                  ...
                  <!-- <small class="form-text text-muted">Choose username using at least 3 of alphanumeric characters (letters and numbers)</small> -->
                  </div>
